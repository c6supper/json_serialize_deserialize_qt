...
class ClientBase
{
    ...
    public:
        ...
        bool Connect(const char *IPAddress, unsigned short port, const char *ethType);
        bool Disconnect();
        bool getCurrentConnectStatus();

        bool SimpleSend(unsigned int type);
        bool SimpleSend(unsigned int type, const unsigned char *data,
                        unsigned int length);
        ...
        int isDirectCall(void);
        void DirectCall(unsigned int type, const unsigned char *data,
                        unsigned int length);
    ...
    private:
        ...
        unsigned char *CreateFrame(const char *appFlag, const unsigned char *data,
                                   unsigned int length, unsigned int type, OUT unsigned char *buffer);
        ...
        void RaiseRecievedEvent(unsigned int type, const unsigned char *data,
                                unsigned int length);
        ...
        unsigned char *GetReceivedData(OUT unsigned char *data,
